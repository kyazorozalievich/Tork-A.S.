...
const Header = () => {
	...
	const products = [
		{ title: 'Gas cylinder refills', href: '/products/refills' },
		{ title: 'Gas filling station', href: '/products/station' },
		{ title: 'Marking of cylinders.', href: '/products/marking' },
	]

	const countries = [
		{ icon: england, title: 'English' },
		{ icon: germany, title: 'Germany' },
		{ icon: france, title: 'France' },
		{ icon: italy, title: 'Italy' },
		{ icon: arabic, title: 'Arabic' },
		{ icon: spain, title: 'Spain' },
	]
		...
		<header className={scss.Header}>
			<div className='container'>
				<div className={scss.content}>
					...
					<div className={`${scss.nav} ${menuOpen ? scss.open : ''}`}>
						<Link
							href='/'
